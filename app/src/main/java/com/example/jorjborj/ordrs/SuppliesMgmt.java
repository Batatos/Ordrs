        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    db.insertItem(name.getText().toString(),Double.parseDouble(price.getText().toString()),Integer.parseInt(amount.getText().toString()),t,c,pic,supplier.getText().toString(),suppliernumber.getText().toString(),0);
